...
#        print('zstd_prefix: '+str(spec['zstd'].prefix)+"include")
        env['BASEFLAGS']="-g -mavx2 -mbmi -mbmi2 -mlzcnt -DZSTD_MULTITHREAD -DDYNAMIC_ZLIB"
        env['DESTDIR']=prefix
        env['PREFIX']=''
        env['ZLIB']=spec['zlib'].libs.ld_flags #+ spec['zstd'].libs.ld_flags
        env['CXXFLAGS'] = "-Wall -O2 -DDYNAMIC_ZLIB"+"-I"+str(spec['zstd'].prefix)+"/include"
        env['CFLAGS'] = "-Wall -O2 -DDYNAMIC_ZLIB"+"-I"+str(spec['zstd'].prefix)+"/include"
